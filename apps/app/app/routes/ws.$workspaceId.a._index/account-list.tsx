        ...
        <tbody className="divide-y divide-stone-200 bg-white dark:divide-stone-700 dark:bg-stone-800">
          {transformedAccounts.map((account) => (
            <tr key={account.accountId} className="hover:bg-stone-100 dark:hover:bg-stone-700">
              ...
              <td
                className="whitespace-nowrap px-4 py-2 pr-0 text-right font-medium text-stone-500 data-[flow=positive]:text-green-500 data-[flow=negative]:text-red-500 "
              ...
              <td className="whitespace-nowrap px-4 py-2 pl-0  text-left font-mono text-sm font-light text-stone-500">
                {account.flowFraction}
              </td>
              <td className="whitespace-nowrap px-4 py-2 pr-0 text-right font-mono font-medium text-stone-900 dark:text-white">
              ...
              <td className="whitespace-nowrap px-4 py-2 pl-0  text-left font-mono text-sm font-light text-stone-900 dark:text-white">
                {account.balanceFraction}
              </td>
              <td className="whitespace-nowrap px-4 py-2 text-left text-xs font-light text-stone-900 dark:text-white">
